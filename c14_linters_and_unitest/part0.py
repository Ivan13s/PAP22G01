...
class MainMenu():
    ...
    def new_mail(self):
        ...
        new_window = MainMenu(window_new,self.__user,self.__pass)
        new_title = self.title + ' Copy'
        new_window.main_window.title(new_title)

        lbf1 = tkinter.Label(self.main_window, text='To:')
        lbf1.grid(row=0, column=0, sticky=tkinter.E)
        lbf1 = tkinter.Label(self.main_window, text='From:')
        lbf1.grid(row=1, column=0, sticky=tkinter.E)
        lbf1 = tkinter.Label(self.main_window, text='Subject: ')
        lbf1.grid(row=2, column=0, sticky=tkinter.E)
