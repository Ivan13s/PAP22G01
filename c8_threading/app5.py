...
class Client(Connect):
    ...
    def send_msg(self):
        ...
        self.sock.send(bytes(f'{self.generate_local_secret()}', encoding='UTF-8'))
...
# conector1 = Connect('localhost', 1502)
# conector2 = Connect('localhost', 1502)
# conector1.generate_prime()
# nr_prim = conector1.prime
# print(nr_prim)
# conector2.get_prime(nr_prim)
# conector1.generate_base()
# base_nr = conector1.base
# print(base_nr)
# conector2.get_base(base_nr)
#
# secret1 = conector1.generate_local_secret()
# secret2 = conector2.generate_local_secret()
# print(secret1, secret2)
# # print(conector1._Connect__local_secret)
# conector1.get_secret(secret2)
# conector2.get_secret(secret1)